...
export async function getPortfolioEntrySignals(): Promise<EntrySignal[]> {
  return apiClient<EntrySignal[]>("/advisor/signals/portfolio");
}

export async function getUniverseEntrySignals(): Promise<EntrySignal[]> {
  return apiClient<EntrySignal[]>("/advisor/signals/universe");
}
