  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-sm font-semibold text-zinc-900">Modo de Análise IA</h3>
        {isUltra && (
          <span className="ml-auto inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-xs font-semibold text-blue-600">
            <Lightning className="h-3 w-3" weight="fill" /> Ultra ativo
          </span>
        )}
      </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-xs text-zinc-500 mt-1">GPT-4o-mini · DeepSeek</p>
              <p className="text-xs text-zinc-400 mt-1">Rápido e econômico</p>
            </button>
            ...
            >
              <div className="flex items-center gap-1">
                <p className="text-sm font-semibold text-zinc-900">Ultra</p>
                {!isPro && (
                  <span className="ml-1 rounded-full bg-amber-100 px-1.5 py-0.5 text-xs font-semibold text-amber-700">Pro</span>
                )}
              </div>
              <p className="text-xs text-zinc-500 mt-1">Claude · GPT-4o · Perplexity</p>
              <p className="text-xs text-zinc-400 mt-1">Máxima qualidade</p>
            </button>
          </div>
