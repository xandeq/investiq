  ...
  return (
    <form onSubmit={handleAdd} className="flex gap-2">
      ...
      <button
        ...
        className="px-4 py-2 text-sm rounded-md bg-blue-500 text-white font-semibold hover:bg-blue-600 active:scale-[0.97] disabled:opacity-60 transition-all duration-150"
      >
