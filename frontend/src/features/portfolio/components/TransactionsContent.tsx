        ...
        <div className="flex items-center gap-2">
          ...
          {transactions.length > 0 && (
            <button
              ...
              className="px-3 py-2 text-sm rounded-md bg-zinc-100 hover:bg-zinc-200 font-medium active:scale-[0.97] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {someSelected && (
        <div className="flex items-center gap-3 px-4 py-2.5 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs rounded-md bg-red-500 text-white font-semibold hover:bg-red-600 active:scale-[0.97] transition-all duration-150"
          >
                ...
                <tr>
                  <td colSpan={9} className="px-4 py-10">
                    <div className="flex flex-col items-center gap-3 text-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-zinc-700">Nenhuma transação encontrada</p>
                        <p className="text-xs text-zinc-400 mt-0.5">Registre suas operações de compra e venda aqui.</p>
                      </div>
                      <button onClick={() => setShowNew(true)} className="text-xs font-medium text-blue-500 hover:text-blue-600 active:scale-[0.97] transition-all duration-150">
