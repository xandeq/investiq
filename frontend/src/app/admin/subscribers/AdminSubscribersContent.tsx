    ...
    <div className="rounded-xl border border-white/10 overflow-hidden">
      <table className="w-full text-sm">
        <thead className="bg-white/5 border-b border-white/10">
          <tr>
            <SortableHeader col="email" label="Email" activeCol={col} dir={dir} onSort={toggle} className={TH} />
            <SortableHeader col="plan" label="Plano" activeCol={col} dir={dir} onSort={toggle} className={TH} />
            <SortableHeader col="subscription_status" label="Status" activeCol={col} dir={dir} onSort={toggle} className={TH} />
            <SortableHeader col="subscription_current_period_end" label="Período até" activeCol={col} dir={dir} onSort={toggle} className={TH} />
            <SortableHeader col="created_at" label="Desde" activeCol={col} dir={dir} onSort={toggle} className={TH} />
          </tr>
        </thead>
        <tbody>
          {sorted.map((s_, i) => {
