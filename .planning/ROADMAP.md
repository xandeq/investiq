...
Plans:
- [ ] 27-01-PLAN.md — Backend: extend MacroRatesResponse with selic field (+ service reads market:macro:selic + tests + frontend type mirror)
...
| Phase | Plans Complete | Status | Completed |
|-------|----------------|--------|-----------|
| 27. Comparador RF vs RV | 0/3 | Planned | — |
