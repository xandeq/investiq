...
| 18-02-W0 | 02 | 0 | SCRF-04 | e2e | `cd frontend && npx playwright test e2e/fii-detail.spec.ts --reporter=list` | **Plan 18-02 Task 1 creates it** | ⬜ pending |
| 18-02-01 | 02 | 2 | SCRF-04 | e2e | `cd frontend && npx playwright test e2e/fii-detail.spec.ts` | ✅ (created by 18-02-W0) | ⬜ pending |
| 18-02-02 | 02 | 2 | SCRF-04 | e2e | `cd frontend && npx playwright test e2e/fii-detail.spec.ts::fii-disclaimer` | ✅ (created by 18-02-W0) | ⬜ pending |
...
- [ ] `frontend/e2e/fii-detail.spec.ts` — smoke + CVM disclaimer regression tests (**created by Plan 18-02 Task 1 Wave 0 step**)
